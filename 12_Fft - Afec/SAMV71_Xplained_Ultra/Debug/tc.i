# 1 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c"
# 1 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c"
# 73 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c"
...
# 74 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 76 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c" 2
# 92 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c"
extern void TC_Configure( Tc *pTc, uint32_t dwChannel, uint32_t dwMode )
{
 TcChannel* pTcCh ;

 ((dwChannel < (sizeof( pTc->TC_CHANNEL )/sizeof( pTc->TC_CHANNEL[0] ))) ? (void)0 : __assert_func ("C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c", 96, __FUNCTION__, "dwChannel < (sizeof( pTc->TC_CHANNEL )/sizeof( pTc->TC_CHANNEL[0] ))")) ;
...
# 120 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c"
extern void TC_Start( Tc *pTc, uint32_t dwChannel )
{
 TcChannel* pTcCh ;

 ((dwChannel < (sizeof( pTc->TC_CHANNEL )/sizeof( pTc->TC_CHANNEL[0] ))) ? (void)0 : __assert_func ("C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c", 124, __FUNCTION__, "dwChannel < (sizeof( pTc->TC_CHANNEL )/sizeof( pTc->TC_CHANNEL[0] ))")) ;

 pTcCh = pTc->TC_CHANNEL+dwChannel ;
 pTcCh->TC_CCR = (0x1u << 0) | (0x1u << 2) ;
}
# 138 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c"
extern void TC_Stop(Tc *pTc, uint32_t dwChannel )
{
 TcChannel* pTcCh ;

 ((dwChannel < (sizeof( pTc->TC_CHANNEL )/sizeof( pTc->TC_CHANNEL[0] ))) ? (void)0 : __assert_func ("C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c", 142, __FUNCTION__, "dwChannel < (sizeof( pTc->TC_CHANNEL )/sizeof( pTc->TC_CHANNEL[0] ))")) ;

 pTcCh = pTc->TC_CHANNEL+dwChannel ;
 pTcCh->TC_CCR = (0x1u << 1) ;
}
# 166 "C:\\Samv7_02\\SAMV7x\\SAMV71x\\hal\\libchip_samv7\\source\\tc.c"
extern uint32_t TC_FindMckDivisor( uint32_t dwFreq, uint32_t dwMCk,
  uint32_t *dwDiv, uint32_t *dwTcClks, uint32_t dwBoardMCK )
{
