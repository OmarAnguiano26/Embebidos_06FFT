...
void CODEC_Init(void)
{
  ...
  WM8904_Write(&pTwid, WM8904_SLAVE_ADDRESS, WM8904_REG_CLOCK_RATE1, WM8904_CLK_SYS_RATE(3) | WM8904_SAMPLE_RATE(5));
	...
	WM8904_Write(&pTwid, WM8904_SLAVE_ADDRESS, WM8904_REG_AUD_INF1, WM8904_BCLK_DIR | WM8904_AIF_FMT_I2S);
  ...
  WM8904_Write(&pTwid, WM8904_SLAVE_ADDRESS, WM8904_REG_ANALOGUE_HP0, 
	...
	wm8904_write_register(WM8904_REG_ANALOGUE_LOUT1, WM8904_HPOUT_VU | WM8904_HPOUTL_VOL(0x39));
	wm8904_write_register(WM8904_REG_ANALOGUE_ROUT1, WM8904_HPOUT_VU | WM8904_HPOUTR_VOL(0x39));
